- This odometer can only show digits 1-9 and only the readings that are in ascending order are valid. The first valid 4 digit reading is 1234 and the last is 6789. 
